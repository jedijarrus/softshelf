...
async def _build_install_command(pkg: dict, agent_id: str) -> str:
    ...
    if archive_type == "archive":
        ...
        parts = [
            ...
            # .NET ZipFile statt Expand-Archive — wirft nicht bei -LiteralPath
            # auf PS 5.1.26100 (Win11 24H2). Ziel-Dir vorher leeren.
            ...
            '    cmd /c "exit 1"\n',
            "}\n",
            # Split-Path -LiteralPath -Parent wirft auf PS 5.1.26100 (Win11 24H2)
            # mit ParameterBinding-Exception. .NET-API ist robust.
